...
function default.register_mgv6_ores()
	...
	minetest.register_ore({ -- Way above cloud height
		ore_type       = "scatter",
	...
	minetest.register_ore({ -- In desert biomes
		ore_type       = "scatter",
		ore            = "default:stone_with_coal",
		wherein        = "default:stone",
		clust_scarcity = 8 * 8 * 8,
		...
		y_max          = 128,
		y_min          = 0,
		biomes = {"desert_ocean", "desert", "desert_sandstone", "cold_desert", "sandstone_desert", "cold_desert_ocean"},
	})
...
function default.register_ores()
	...
	minetest.register_ore({ -- Far above cloud height
		ore_type       = "scatter",
		ore            = "default:stone_with_coal",
		wherein        = "default:stone",
		clust_scarcity = 8 * 8 * 8,
	...
	minetest.register_ore({ -- Surface level
		ore_type       = "scatter",
		ore            = "default:stone_with_coal",
		wherein        = "default:stone",
		clust_scarcity = 8 * 8 * 8,
	...
	minetest.register_ore({ -- Final layer
		ore_type       = "scatter",
		ore            = "default:stone_with_coal",
		wherein        = "default:stone",
		clust_scarcity = 12 * 12 * 12,
	...
	minetest.register_ore({ -- In various erosion and high altitude biomes
		ore_type       = "scatter",
		ore            = "default:stone_with_iron",
		wherein        = "default:stone",
		clust_scarcity = 9 * 9 * 9,
		...
		y_max          = 1024,
		y_min          = -255,
		biomes         = {"desert_ocean", "rainforest_ocean", "savanna_ocean", "tundra_ocean", "snowy_grassland_ocean", "grassland_ocean", "coniferous_forest_ocean", "deciduous_forest_ocean", "cold_desert_ocean", "sandstone_desert_ocean"},
	})
	
	minetest.register_ore({ -- Initial sparse layer starting at -128
		ore_type       = "scatter",
		ore            = "default:stone_with_iron",
		wherein        = "default:stone",
	...
	minetest.register_ore({ -- Final dense layer picking up at -512
		ore_type       = "scatter",
		ore            = "default:stone_with_iron",
		wherein        = "default:stone",
		clust_scarcity = 12 * 12 * 12,
